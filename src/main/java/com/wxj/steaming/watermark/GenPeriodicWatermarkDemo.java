 ...
 * @Description: TODO
 */
public class GenPeriodicWatermarkDemo {
    public static void main(String[] args) throws Exception {
        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
        env.setParallelism(1);
        env.getConfig().setAutoWatermarkInterval(2000);  // 设置成2s，方便测试
        ...
        SingleOutputStreamOperator<WaterSensor> dsWithWatermark = ds.assignTimestampsAndWatermarks(
                ...
                WatermarkStrategy
                        ...
                        .<WaterSensor>forGenerator(ctx -> new MyPeriodicWatermarkGenerator<>(3 * 1000))
                        // 从数据中提取时间戳
...
//                WatermarkStrategy.noWatermarks()
    ...
    public static class MyPeriodicWatermarkGenerator<WaterSensor> implements WatermarkGenerator<WaterSensor> {
        ...
        public void onEvent(WaterSensor event, long eventTimestamp, WatermarkOutput output) {
            ...
            System.out.println("调用 MyWatermarkGenerator.onEvent() 方法，获取最大时间戳："+maxTs);
        }
        ...
        public void onPeriodicEmit(WatermarkOutput output) {
            ...
            System.out.println("调用 MyWatermarkGenerator.onPeriodicEmit() 方法，生成 watermark："+(maxTs - delayTs - 1));
        }
    }
}
